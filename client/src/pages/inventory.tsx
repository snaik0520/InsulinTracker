  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Card className="mb-8 w-full max-w-10x1 mx-auto">
        ...
        <Card className="w-full max-w-10x1 mx-auto">
          <CardHeader>
        ...
        <div id="low-stock-ticker" className="mt-8 w-full max-w-10x1 mx-auto">
          <LowStockTicker />
        </div>

        <div className="w-full max-w-10x1 mx-auto">
  <OutOfStockTracker />
</div>
      </main>
