  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <main className="max-w-10xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Card className="mb-8 w-full max-w-14xl mx-auto">
        ...
        <Card className="w-full max-w-14xl mx-auto">
          <CardHeader>
                    ...
                    filteredMedications.map((medication) => {
                      ...
                      return (
                        <tr key={medication.id} className={`${rowTint} hover:bg-gray-50`}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-450">
        ...
        <div id="low-stock-ticker" className="mt-8 w-full max-w-14xl mx-auto">
          <LowStockTicker />
        </div>
