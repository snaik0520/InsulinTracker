  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Card className="mb-8 w-full max-w-15x1 mx-auto">
        ...
        <Card className="w-full max-w-15x1 mx-auto">
          <CardHeader>
                      ...
                      return (
                        <tr key={medication.id} className={`${rowTint} hover:bg-gray-50`}>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-500">
                            <div className="min-w-[60px] max-w-[105px] break-words whitespace-normal">
                              {medication.location ?? "—"}
                            </div>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-center">
        ...
        <div id="low-stock-ticker" className="mt-8 w-full max-w-15x1 mx-auto">
          <LowStockTicker />
        </div>

        <div className="w-full max-w-15x1 mx-auto">
  <OutOfStockTracker />
</div>
      </main>
