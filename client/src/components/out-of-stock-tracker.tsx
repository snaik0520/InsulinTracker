...
export function OutOfStockTracker() {
  ...
  // Filter out-of-stock medications with valid expiration date and medical name
  const outOfStockMedications = medications.filter((med) => 
    (med.quantity ?? 0) === 0 && 
    med.expirationDate && 
                  ...
                  {outOfStockMedications.map((medication) => (
                    ...
                    >
                      <div className="flex-1">
                        <div className="font-medium">{medication.medicalName}</div>
